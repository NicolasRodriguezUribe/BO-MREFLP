...
public class ConstructiveB {

    public SolutionPositionsCosts C1_GR(ArrayList<ArrayList<Integer>> mhc, ArrayList<ArrayList<Integer>> crs, int m, int n) {
        ...
        while (!facilities.isEmpty()) {
            ...
            double threshold = CL.get(0).getSolution().getCostSolutionO1() * alpha + CL.get(CL.size() - 1).getSolution().getCostSolutionO1() * (1 - alpha);
    ...
    public SolutionPositionsCosts C2_RG(ArrayList<ArrayList<Integer>> mhc, ArrayList<ArrayList<Integer>> crs, int n, int m) {
        Common common = new Common();
        Evaluation evaluation = new Evaluation();
        ArrayList<Integer> facilities = new ArrayList<>(n);
    ...
    public SolutionPositionsCosts C3_GR(ArrayList<ArrayList<Integer>> mhc, ArrayList<ArrayList<Integer>> crs, int m, int n) {
        Common common = new Common();
        Evaluation evaluation = new Evaluation();
        ArrayList<Integer> facilities = new ArrayList<>(n);
        ...
        while (!facilities.isEmpty()) {
            ...
            //Calculation of the threshold
            double threshold = CL.get(0).getSolution().getCostSolutionO2() * alpha + CL.get(CL.size() - 1).getSolution().getCostSolutionO2() * (1 - alpha);
    ...
    public SolutionPositionsCosts C4_RG(ArrayList<ArrayList<Integer>> mhc, ArrayList<ArrayList<Integer>> crs, int n, int m) {
        Common common = new Common();
        Evaluation evaluation = new Evaluation();
        ArrayList<Integer> facilities = new ArrayList<>(n);
